...
# mniejsza od wszystkich liczb wylosowanych z pudełek o większych numerach.

# dokładna odpowiedź 0.004845
...
length(wylosowane[wylosowane == TRUE]) / N
